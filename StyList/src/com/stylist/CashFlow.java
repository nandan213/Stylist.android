...
public class CashFlow extends Activity implements OnClickListener ,OnMenuItemSelectedListener{
	...
	public void setContentView(int id) {
		...
		View view = CashFlow.this.getLayoutInflater().inflate(
	...
	public void intializeUIView(){
		...
		mMenu = new CustomMenu(CashFlow.this, CashFlow.this, getLayoutInflater());
